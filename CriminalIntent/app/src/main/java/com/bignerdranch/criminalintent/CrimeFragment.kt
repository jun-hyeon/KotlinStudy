...
private const val DATE_FORMAT = "yyyy년 M월 d일 m분, E요일"
...
class CrimeFragment : Fragment(),  DatePickerFragment.Callbacks {
    ...
    override fun onCreateView(
        ...
        activityResultCamera = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){activityResult ->
            if(activityResult.resultCode == RESULT_OK){
        ...
        suspectButton.apply {
            ...
            setOnClickListener{
                activityResultLauncher.launch(pickContactIntent)
            }
        ...
        photoButton.apply {
            ...
            setOnClickListener{
                ...
                activityResultLauncher.launch(captureImage)
            }
        }
